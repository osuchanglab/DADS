...
knitr::opts_knit$set(root.dir = "~/Documents/Postdoc/DADS")
...
#Rename treatment factor levels to Mock-treated and DADS treated instead of untreated and DADS_treated
dads_5asv_its.ps@sam_data$Treatment <- factor(dads_5asv_its.ps@sam_data$Treatment, levels = c("untreated", "DADS_treated"), labels = c("Mock-treated", "DADS treated"))
dads_5asv_16S.ps@sam_data$Treatment <- factor(dads_5asv_16S.ps@sam_data$Treatment, levels = c("untreated", "DADS_treated"), labels = c("Mock-treated", "DADS treated"))
dads_5asv_rps10.ps@sam_data$Treatment <- factor(dads_5asv_rps10.ps@sam_data$Treatment, levels = c("untreated", "DADS_treated"), labels = c("Mock-treated", "DADS treated"))

dads_5asv_its.ps@sam_data$Soil <- factor(dads_5asv_its.ps@sam_data$Soil, levels = c("madras", "tulelake"), labels = c("Madras", "Tulelake"))
dads_5asv_16S.ps@sam_data$Soil <- factor(dads_5asv_16S.ps@sam_data$Soil, levels = c("madras", "tulelake"), labels = c("Madras", "Tulelake"))
dads_5asv_rps10.ps@sam_data$Soil <- factor(dads_5asv_rps10.ps@sam_data$Soil, levels = c("madras", "tulelake"), labels = c("Madras", "Tulelake"))

#Any way to rename Soil factor as Location? 
#instead of dads_5asv_its.ps@sam_data$Soil I want dads_5asv_its.ps@sam_data$Location
dads_5asv_its.ps@sam_data$Location <- dads_5asv_its.ps@sam_data$Soil
dads_5asv_16S.ps@sam_data$Location <- dads_5asv_16S.ps@sam_data$Soil
dads_5asv_rps10.ps@sam_data$Location <- dads_5asv_rps10.ps@sam_data$Soil
```
...
plot_its_trt <- ggplot(ordination_df, aes(x = MDS1, y = MDS2, fill = Treatment)) +
  geom_point(size = 4, shape = 21, color = "black", stroke = 0.5, position = position_jitter(width = 0.035, height = 0.035)) +
  labs(x = "NMDS1",
       y = "NMDS2", 
       fill = "Treatment") +
...
plot_its_location <- ggplot(ordination_df, aes(x = MDS1, y = MDS2, fill = Location)) +
  geom_point(size = 4, shape = 21, color = "black", stroke = 0.5, position = position_jitter(width = 0.035, height = 0.035)) +
  labs(x = "NMDS1",
       y = "NMDS2", 
       fill = "Location") +
...
plot_16S_location <- ggplot(ordination_df, aes(x = MDS1, y = MDS2, fill = Location)) +
  geom_point(size = 4, shape = 21, color = "black", stroke = 0.5, position = position_jitter(width = 0.035, height = 0.035)) +
  labs(x = "NMDS1",
       y = "NMDS2", 
       fill = "Location") +
...
plot_rps10_location <- ggplot(ordination_df, aes(x = MDS1, y = MDS2, fill = Location)) +
  geom_point(size = 4, shape = 21, color = "black", stroke = 0.5, position = position_jitter(width = 0.035, height = 0.035)) +
  labs(x = "NMDS1",
       y = "NMDS2", 
       fill = "Location") +
...
# Create columns for each dataset and factor with adjusted spacing
col_16S_treatment <- create_column(plot_16S_trt)
col_16S_location <- create_column(plot_16S_location)
col_16S_incubation <- create_column(plot_16S_inc)
col_its_treatment <- create_column(plot_its_trt)
col_its_location <- create_column(plot_its_location)
col_its_incubation <- create_column(plot_its_inc)
col_rps10_treatment <- create_column(plot_rps10_trt)
col_rps10_location <- create_column(plot_rps10_location)
col_rps10_incubation <- create_column(plot_rps10_inc)

# Create row plots with labels and adjusted spacing
row_16S <- plot_grid(col_16S_treatment, col_16S_location, col_16S_incubation, 
                     ncol = 3, labels = "A.", label_size = 20, label_x =  -0.01, label_y = 1.02, hjust = -0.5, vjust = 2, rel_widths = c(1, 1, 1))
row_its <- plot_grid(col_its_treatment, col_its_location, col_its_incubation, 
                     ncol = 3, labels = "B.", label_size = 20, label_x =  -0.01, label_y = 1.02, hjust = -0.5, vjust = 2, rel_widths = c(1, 1, 1))
row_rps10 <- plot_grid(col_rps10_treatment, col_rps10_location, col_rps10_incubation, 
                       ncol = 3, labels = "C.", label_size = 20, label_x =  -0.01, label_y = 1.02, hjust = -0.5, vjust = 2, rel_widths = c(1, 1, 1))
