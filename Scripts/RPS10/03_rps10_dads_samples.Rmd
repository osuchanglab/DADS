...
ggsave("Figures/DADS/RPS10/relabundance_plot_treatment_relabund_species_dads.pdf", abund_plot, width = 22, height = 16)
```
...
ggsave("Figures/DADS/RPS10/relabundance_plot_soil_relabund_species_dads.pdf", abund_plot, width = 22, height = 16)
```
...
ggsave("Figures/DADS/RPS10/relabundance_plot_incubation_relabund_species_dads.pdf", abund_plot, width = 22, height = 16)
```
...
pdf("Figures/DADS/RPS10/top40_species_dads.pdf", width = 34, height = 20)
...
write.csv(data_summed, file="Results/DADS/RPS10/mostabundanttaxa_abundance_dads_species.csv",row.names = TRUE)
...
write.csv(data_summed, file="Results/DADS/RPS10/mostabundanttaxa_abundance_dads_genus.csv",row.names = TRUE)
...
write.csv(data_summed1, file="Results/DADS/RPS10/mostabundanttaxa_relativeabundance_untreatedtreated_dads.csv",row.names = TRUE)
...
write.csv(data_summed2, file="Results/DADS/RPS10/mostabundanttaxa_untreatedtreated_dads.csv",row.names = TRUE)
```
...
write.csv(final_anova_table, "Results/DADS/RPS10/final_anova_table_dads.csv", row.names = FALSE)
```
...
ggsave(plots_arrange_with_text, path = "Figures/DADS/RPS10", filename = "alpha_diversity_each_factor_dads.pdf", 
       width = 12, height = 16)
```
...
# Save results
write.csv(final_results, file = "Results/DADS/RPS10/PERMANOVA_interactions_with_betadisper.csv", row.names = FALSE)
```
...
ggsave("Figures/DADS/RPS10/permanova_interactions_heatmap_dads.pdf", plot = heatmap, width = 8, height = 6)
```
...
write.csv(ps_pcoa[["points"]], file="Results/DADS/RPS10/RPS10_pcoa_coordinates_persample.csv",row.names = TRUE)
...
# Export to CSV
write.csv(dads.wilcox.dt, file = "Results/DADS/RPS10/wilcox_treat_vs_untreat_dads.csv", row.names = FALSE)
```
...
write.csv(dads.sig.dt, file="Results/DADS/RPS10/deseq_trt_dads.csv",row.names = TRUE)
...
# Save the plot
ggsave("Figures/DADS/RPS10/Deseq_treatment_barplot_dads_ASV.pdf", deseqplot2, width=40, height=40)
...
write.csv(final_table, "Results/DADS/RPS10/merged_deseq_trt_wilcoxon_results.csv", row.names = FALSE)
...
# Save the plot
ggsave("Figures/DADS/RPS10/Deseq_merged_trt_barplot_dads_ASV.pdf", merged_plot, height=30, width=40)
...
# Export to CSV
write.csv(dads.wilcox.dt, file = "Results/DADS/RPS10/wilcox_soil_dads.csv", row.names = FALSE)
```
...
write.csv(dads.sig.dt, file="Results/DADS/RPS10/deseq_soil_dads.csv",row.names = TRUE)
# Now, let's create the plot
...
# Save the plot
ggsave("Figures/DADS/RPS10/Deseq_soil_barplot_dads_ASV.pdf", deseqplot2)
...
# Save the final table as CSV
write.csv(final_table, "Results/DADS/RPS10/merged_deseq_soil_wilcoxon_results.csv", row.names = FALSE)
print(paste("Number of ASVs in the final table:", nrow(final_table)))
```
...
# Save the plot
ggsave("Figures/DADS/RPS10/Deseq_merged_soil_barplot_dads_ASV.pdf", merged_plot)
...
# Export to CSV
write.csv(dads.wilcox.dt, file = "Results/DADS/RPS10/wilcox_incubation_dads.csv", row.names = FALSE)
```
...
write.csv(dads.sig.dt, file="Results/DADS/RPS10/deseq_incubation_dads.csv",row.names = TRUE)
...
# Save the plot
ggsave("Figures/DADS/RPS10/Deseq_incubation_barplot_dads_ASV.pdf", deseqplot2)
...
# Save the final table as CSV
write.csv(final_table, "Results/DADS/RPS10/merged_deseq_incubation_wilcoxon_results.csv", row.names = FALSE)
print(paste("Number of ASVs in the final table:", nrow(final_table)))
```
...
# Save the plot
ggsave("Figures/DADS/RPS10/Deseq_merged_incubation_barplot_dads_ASV.pdf", merged_plot)
...
obj_RPS10 %>%
  ...
  heat_tree_matrix(data = "diff_table",
                   ...
                   key_size = 0.67,
                   output_file = "Figures/DADS/RPS10/diff_abundance_heattree_Wilcoxonranksum_dads_RPS10_fdr.pdf")
```
...
obj_RPS10_rarefy$data$diff_table <- metacoder::compare_groups(obj_RPS10_rarefy,
                                      ...
                                      groups = obj_RPS10_rarefy$data$sample_data$Treatment) # What category each sample is assigned to
...
obj_RPS10_rarefy %>%
  ...
  heat_tree_matrix(data = "diff_table",
                   ...
                   layout = "da", initial_layout = "re",
                   key_size = 0.67,
                   output_file = "Figures/DADS/RPS10/diff_abundance_heattree_Wilcoxonranksum__rarefy_dads_RPS10_fdr.pdf")
```
...
obj_RPS10 %>%
  ...
  heat_tree_matrix(data = "diff_table_deseq",
                   ...
                   layout = "da", initial_layout = "re",
                   key_size = 0.4,
                   output_file = "Figures/DADS/RPS10/diff_abundance_heattree_deseq_dads_RPS10.pdf") # The layout algorithm that initializes node locations
```
