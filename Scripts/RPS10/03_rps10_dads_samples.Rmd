...
obj_RPS10 %>%
  ...
  heat_tree_matrix(data = "diff_table",
                   ...
                   key_size = 0.67,
                   output_file = "Figures/RPS10/diff_abundance_heattree_Wilcoxonranksum_dads_RPS10_fdr.pdf")
```
...
obj_RPS10_rarefy %>%
  ...
  heat_tree_matrix(data = "diff_table",
                   ...
                   layout = "da", initial_layout = "re",
                   key_size = 0.67,
                   output_file = "Figures/RPS10/diff_abundance_heattree_Wilcoxonranksum__rarefy_dads_RPS10_fdr.pdf")
```
...
obj_RPS10 %>%
  ...
  heat_tree_matrix(data = "diff_table",
                   ...
                   layout = "da", initial_layout = "re",
                   key_size = 0.67,
                   output_file = "Figures/RPS10/diff_abundance_heattree_Wilcoxonranksum_relabundance_dads_RPS10_fdr.pdf")
```
