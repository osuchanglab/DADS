...
write.csv(data_summed, file="Results/DADS/ITS/mostabundanttaxa_abundance_dads_species.csv",row.names = TRUE)
...
write.csv(data_summed, file="Results/DADS/ITS/mostabundanttaxa_abundance_dads_genus.csv",row.names = TRUE)
...
# 
# # Save the plot
# ggsave("Figures/DADS/ITS/Deseq_incubation_barplot_dads_ASV.pdf", deseqplot2)
# 
# # Display the plot
# print(deseqplot2)
```
