...
obj_16S %>%
  ...
  heat_tree_matrix(data = "diff_table",
                   ...
                   key_size = 0.67,
                   output_file = "Figures/16S/diff_abundance_heattree_Wilcoxonranksum_dads_16S_fdr.pdf")
```
...
obj_16S_rarefy %>%
  ...
  heat_tree_matrix(data = "diff_table",
                   ...
                   layout = "da", initial_layout = "re",
                   key_size = 0.67,
                   output_file = "Figures/16S/diff_abundance_heattree_Wilcoxonranksum__rarefy_dads_16S_fdr.pdf")
```
...
obj_16S %>%
  ...
  heat_tree_matrix(data = "diff_table",
                   ...
                   layout = "da", initial_layout = "re",
                   key_size = 0.67,
                   output_file = "Figures/16S/diff_abundance_heattree_Wilcoxonranksum_relabundance_dads_16S_fdr.pdf")
```
