...
ASV_tables_bray_rarefy <- phyloseq::distance(rarefied.ps, method = "bray")
...
pvals <- sapply(colnames(mapping2), function(variable){
  ...
  form1<-as.formula(paste("ASV_tables_bray_rarefy", variable, sep="~"))
...
range(obj_ITS$data$diff_table_deseq$padj, finite = TRUE) 
